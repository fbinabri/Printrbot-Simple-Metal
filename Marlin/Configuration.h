 ...
 */
#define TEMP_SENSOR_0 1 //Ubis 13S
...
#define Z_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop. (for using Inductive Sensor)
#define X_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // set to true to invert the logic of the probe. (for using FSR Nozzle Probe)
 ...
 *
 */
//#define Z_MIN_PROBE_ENDSTOP //FSR connected to Y_MAX_PIN
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 110  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.45   // Z offset: -below +above  [the nozzle] (FSR Nozzle offset)
 ...
 */
  ...
  #define PROBE_PT_1_X 11
  #define PROBE_PT_1_Y 170
  #define PROBE_PT_2_X 11
